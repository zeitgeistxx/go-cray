...
func (h *Handler) RegisterRoutes(router *mux.Router) {
	...
	router.HandleFunc("/{productID}", h.handleGetProduct).Methods(http.MethodGet)

	router.HandleFunc("/create", auth.WithJWTAuth(h.handleCreateProduct, h.userStore)).Methods(http.MethodPost)
}
